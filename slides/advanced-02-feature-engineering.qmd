...
There are a lot of examples in [*Feature Engineering and Selection*](https://bookdown.org/max/FES/) (FES).
...
Feature hashing (for more see [*FES*](https://bookdown.org/max/FES/encoding-predictors-with-many-categories.html), [*SMLTAR*](https://smltar.com/mlregression.html#case-study-feature-hashing), and [*TMwR*](https://www.tmwr.org/categorical.html#feature-hashing)):
...
[Hash functions](https://www.metamorphosite.com/one-way-hash-encryption-sha1-data-software) are meant to *emulate* randomness.
